package com.sobok.userservice.common.aspects;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.sobok.userservice.user.service..*(..))")
    public void serviceMethods() {
    }

    @Pointcut("execution(* com.sobok.userservice.user.controller..*(..))")
