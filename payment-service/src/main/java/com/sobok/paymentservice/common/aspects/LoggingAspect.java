package com.sobok.paymentservice.common.aspects;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.sobok.paymentservice.payment.service..*(..))")
    public void serviceMethods() {
    }

    @Pointcut("execution(* com.sobok.paymentservice.payment.controller..*(..))")
