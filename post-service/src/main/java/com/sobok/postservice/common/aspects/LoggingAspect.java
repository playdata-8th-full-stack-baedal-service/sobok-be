package com.sobok.postservice.common.aspects;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.sobok.postservice.post.service..*(..))")
    public void serviceMethods() {
    }

    @Pointcut("execution(* com.sobok.postservice.post.controller..*(..))")
