package com.sobok.adminservice.common.aspects;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.sobok.adminservice.admin.service..*(..))")
    public void serviceMethods() {
    }

    @Pointcut("execution(* com.sobok.adminservice.admin.controller..*(..))")
