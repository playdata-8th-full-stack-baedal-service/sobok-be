package com.sobok.deliveryservice.common.security;
...
import com.sobok.deliveryservice.common.enums.Role;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    List<String> whiteList = List.of(
            "/actuator/**", "/delivery/signup", "/auth/check-permission", "/delivery/check-permission", "/v3/**"
    );
    @Value("${jwt.secretKey}")
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        log.info("Delivery Service에 요청이 발생했습니다.");
