package com.sobok.authservice.common.aspects;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.sobok.authservice.auth.service..*(..))")
    public void serviceMethods() {
    }

    @Pointcut("execution(* com.sobok.authservice.auth.controller..*(..))")
