package com.sobok.cookservice.common.aspects;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.sobok.cookservice.cook.service..*(..))")
    public void serviceMethods() {
    }

    @Pointcut("execution(* com.sobok.cookservice.cook.controller..*(..))")
