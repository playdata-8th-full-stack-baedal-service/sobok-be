...
public interface CookControllerDocs {
    ...
    @Operation(summary = "요리 전체 조회 (페이징)")
    @ApiResponses({
    ...
    @Operation(summary = "키워드로 요리 검색 (페이징)")
    @ApiResponses({
    ...
    @Operation(summary = "카테고리로 요리 검색 (페이징)")
    @ApiResponses({
    ...
    @Operation(summary = "한달 주문량 기준 요리 페이지 조회")
    @ApiResponses({
    ...
    @Operation(summary = "한달 주문량 기준 요리 목록 전체 조회")
    @ApiResponses({
